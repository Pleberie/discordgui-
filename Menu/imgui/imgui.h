...
namespace ImGui
{
	...
	// Widgets: Main
	IMGUI_API bool ButtonT(const char* label, ImU32 clr, const ImVec2& size_arg, bool active);
	IMGUI_API bool          Button(const char* label, const ImVec2& size = ImVec2(0, 0));            // button
	IMGUI_API bool          Tab(const char* label, bool enable, const ImVec2& size = ImVec2(0, 0));            // button
 ...
 //   IMGUI_API bool   static bool BeginChildEx(const char* name, ImGuiID id, const ImVec2& size_arg, bool border, ImGuiWindowFlags flags);
